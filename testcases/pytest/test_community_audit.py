...
'''
社群发布审核:
取消删除:test_del_cancel_community
删除:test_del_succ_community
审核:test_Auditcommunity   
...
class TestAuditcommunity(object):
    ...
    def test_goto_aduit_community(self):
        """
        进入社群发布审核页
        :return:
        """
    ...
    # 取消删除社群发布审核数据
    def ntest_del_cancel_community(self):
        """
        这是社群发布删除取消操作用例
        :return:
        """
    ...
    # 删除社群发布审核数据
    def ntest_del_suc_community(self):
        """
        这是社群发布删除操作用例--删除的是列表中第一条数据
        :return:
        """
        # 获取列表数
        total = util.get_total(self.login.driver, '.ant-pagination-total-text')
    ...
    def ntest_Audit_community(self):
        '''
        这里是社群发布审核
        :return:
        '''
    ...
    def ntest_search_community_not_exist(self):
        '''
        这里是查询社群发布信息审核列表--不存在
        :return:
        '''
    ...
    def test_search_community_exist(self):
        '''
        这里是查询社群发布信息审核列表--存在
        :return:
        '''
        ...
        # 点击展开，把所有的搜索条件展示出来：
        self.login.driver.find_element(By.XPATH, '/html/body/app-root/div/app-default/app-def-layout-content/nz-layout/nz-layout/nz-layout/nz-content/div/div/app-dept/div/nz-card/div/form/div/div[3]/a/span').click()
        # 输入标题到搜索框
...
if __name__ == '__main__':
    pytest.main('-vs', '[test_community_audit.py]', '--reruns=2')
